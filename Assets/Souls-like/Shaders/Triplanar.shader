	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar11 = TriplanarSampling11( _Albedo_1, WorldPosition, WorldNormal, 1.0, float2( 1,1 ), 1.0, 0 );
				
				float3x3 ase_worldToTangent = float3x3(WorldTangent,WorldBiTangent,WorldNormal);
				float3 triplanar12 = TriplanarSampling12( _Normal_1, WorldPosition, WorldNormal, 1.0, float2( 1,1 ), 1.0, 0 );
				float3 tanTriplanarNormal12 = mul( ase_worldToTangent, triplanar12 );
				
				float4 triplanar13 = TriplanarSampling13( _Mask_1, WorldPosition, WorldNormal, 1.0, float2( 1,1 ), 1.0, 0 );
				

				float3 BaseColor = ( _BaseColor * triplanar11 ).rgb;
				float3 Normal = tanTriplanarNormal12;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( triplanar13.x * _Metallic );
				float Smoothness = ( 0.0 * _Smoothness );
				float Occlusion = _AO;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar11 = TriplanarSampling11( _Albedo_1, WorldPosition, ase_worldNormal, 1.0, float2( 1,1 ), 1.0, 0 );
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;145.885,364.1438;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;154.2049,233.1036;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-282.9728,467.1254;Inherit;False;Property;_Metallic;Metallic;3;0;Create;True;0;0;0;False;0;False;0;0.1302649;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-272.093,591.4456;Inherit;False;Property;_Smoothness;Smoothness;4;0;Create;True;0;0;0;False;0;False;0;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-176.333,698.5662;Inherit;False;Property;_AO;AO;5;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;99.77539,-242.8442;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;25;-281.3446,-436.0442;Inherit;False;Property;_BaseColor;BaseColor;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.8716981,0.8716981,0.8716981,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;13;-409.58,219.3072;Inherit;True;Spherical;World;False;Mask_1;_Mask_1;white;2;None;Mid Texture 2;_MidTexture2;white;-1;None;Bot Texture 2;_BotTexture2;white;-1;None;Mask;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;12;-432.6201,-2.692898;Inherit;True;Spherical;World;True;Normal_1;_Normal_1;bump;1;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Normal;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;11;-469.4203,-221.493;Inherit;True;Spherical;World;False;Albedo_1;_Albedo_1;white;0;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Albedo;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=AD3B1F79F7EBB41967914AF5A4BDEB2CF1B1A5CC